...
import net.iubris.optimus_saint.crawler.skills.SkillsGroup;
import net.iubris.optimus_saint.crawler.skills.SkillsGroupAdapter;
import net.iubris.optimus_saint.crawler.stats.StatsArrayAdapter;
import net.iubris.optimus_saint.crawler.stats.StatsGroup;
import net.iubris.optimus_saint.crawler.value.description.DescriptionAdapter;
import net.iubris.optimus_saint.crawler.value.lane.Lane;
import net.iubris.optimus_saint.crawler.value.lane.LaneAdapter;
import net.iubris.optimus_saint.crawler.value.name.NameAdapter;
import net.iubris.optimus_saint.crawler.value.tiers.TiersGroup;
import net.iubris.optimus_saint.crawler.value.tiers.TiersGroupAdapter;
import net.iubris.optimus_saint.crawler.value.type.Type;
import net.iubris.optimus_saint.crawler.value.type.TypeAdapter;
